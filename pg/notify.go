...
var errListenerConnClosed = errors.New("pg: ListenerConn has been closed")
...
var errListenerClosed = errors.New("pg: Listener has been closed")

var ErrChannelAlreadyOpen = errors.New("pg: channel is already open")
var ErrChannelNotOpen = errors.New("pg: channel is not open")
...
const (
	...
	// emitted, a nil pg.Notification is sent on the Listener.Notify channel.
...
//      pg.Error containing the information the server supplied.
